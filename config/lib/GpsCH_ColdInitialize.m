...
function channel = GpsCH_ColdInitialize(channel, Syst, CH_Status, prn, configPage, GSAR_CONSTANTS, device)
...
switch Syst
    case {'GPS_L1CA','B1I_L1CA','L1CA_L2C'}
        ...
        channel.CH_L1CA.Tcoh_I      = zeros(3,1);
        channel.CH_L1CA.Tcoh_Q      = zeros(3,1);
        channel.CH_L1CA.Tcoh_I_prev = zeros(3,1);
        channel.CH_L1CA.Tcoh_Q_prev = zeros(3,1);
        ...
        channel.CH_L1CA.lockDect.snr         = 0;   % 用载噪比
        channel.CH_L1CA.lockDect.snrThre     = configPage.trackConfig.lockDect.snrThrelol;  % 此处用载噪比
        ...
        channel.CH_L1CA.lockDect.sigma_checkT= configPage.trackConfig.lockDect.sigma_checkT;      
        ...
        channel.CH_L1CA.lockDect.WN = 0;
        channel.CH_L1CA.lockDect.SOW = 0;
        channel.CH_L1CA.lockDect.Frame_N = 0;
        channel.CH_L1CA.lockDect.SubFrame_N = 0;
        channel.CH_L1CA.lockDect.Word_N = 0;
        channel.CH_L1CA.lockDect.Bit_N = 0;
        channel.CH_L1CA.lockDect.T1ms_N = 0;
        channel.CH_L1CA.lockDect.codePhase = 0;
        channel.CH_L1CA.lockDect.carriPhase = 0;
        channel.CH_L1CA.lockDect.carriDopp = 0;
        channel.CH_L1CA.lockDect.codeDopp = 0;
...
%         channel.CH_L1CA.CorrM_Bank.uncancelled_corrM_Q_vt_Save = zeros(channel.CH_L1CA.CorrM_Bank.corrM_Num, 1);
        ...
        channel.CH_L1CA.acq.processing = 0;
        channel.CH_L1CA.acq.TimeLen    = 0;
        channel.CH_L1CA.acq.hotWaitTime = -9999;
        channel.CH_L1CA.acq.hotAcqTime = 0;
        channel.CH_L1CA.acq.acq_parameters = CH_Cold_AcqParameters_Init(channel.SYST, ...
                                                                       [], ...
        ...
        channel.CH_L1CA.acq.sampPerTC_s= ceil(GSAR_CONSTANTS.STR_RECV.fs * codePeriod_L1CA);
        ...
        channel.CH_L1CA.acq.skipNperCode      = 0;
        ...
        channel.CH_L1CA.bitSync.processing = -1;% -1：初始化，0：经过推算后，1：经过捕获初始化后
