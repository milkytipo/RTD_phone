% In this function, all GPS_L1CA_L2C channels will be initialized as code start.
function channel = GpsCH_L1L2_ColdInitialize(channel, prn, configPage)
...
channel.CH_L1CA_L2C.PLL_L2.Bn  = configPage.trackConfig.pll.Bn;
channel.CH_L1CA_L2C.PLL_L2.Ord = configPage.trackConfig.pll.Ord;
channel.CH_L1CA_L2C.PLL_L2.Fn  = configPage.trackConfig.pll.Fn;
channel.CH_L1CA_L2C.PLL_L2.REG = zeros(4,1);   % Filter registers
channel.CH_L1CA_L2C.PLL_L2.IQ_d= zeros(2,1);
channel.CH_L1CA_L2C.PLL_L2.LoopType = configPage.trackConfig.pll.LoopType;
...
channel.CH_L1CA_L2C.DLL_L2.Dn  = configPage.trackConfig.dll.Dn;
channel.CH_L1CA_L2C.DLL_L2.Ord = configPage.trackConfig.dll.Ord;
channel.CH_L1CA_L2C.DLL_L2.SPACING    = configPage.trackConfig.dll.SPACING;
channel.CH_L1CA_L2C.DLL_L2.SPACING_MP = configPage.trackConfig.dll.SPACING_MP;
...
channel.CH_L1CA_L2C.KalPreFilt_L1L2.P0           = configPage.trackConfig.kalmanFilt_L1L2.P0;
channel.CH_L1CA_L2C.KalPreFilt_L1L2.P            = diag(channel.CH_L1CA_L2C.KalPreFilt_L1L2.P0);
channel.CH_L1CA_L2C.KalPreFilt_L1L2.Q            = configPage.trackConfig.kalmanFilt_L1L2.Q;
channel.CH_L1CA_L2C.KalPreFilt_L1L2.R            = configPage.trackConfig.kalmanFilt_L1L2.R;
...
channel.CH_L1CA_L2C.LO_Fcode_fd  = 0;
...
channel.CH_L1CA_L2C.WN        = -1;
channel.CH_L1CA_L2C.TOW_6SEC  = -1;
channel.CH_L1CA_L2C.SubFrame_N= -1;
channel.CH_L1CA_L2C.Word_N    = -1;
channel.CH_L1CA_L2C.Bit_N     = -1;
channel.CH_L1CA_L2C.T1ms_N    = -1;
channel.CH_L1CA_L2C.bitInMessage = -1;
channel.CH_L1CA_L2C.CM_in_CL  = -1;
...
channel.CH_L1CA_L2C.Tcohn_N     = 10;  
