function [el, az, iono, trop, psr, satelliteTable] = sats_el_az_psr_predict_BDS(satpos, activeChannel_BDS, posForecast, satelliteTable, eph_para, recv_timer)
...
[ Lat, Lon, Hight ] = cart2geo( posForecast(1), posForecast(2), posForecast(3), 5 );
...
%     end
    ...
    iono(prn) = Ionospheric_BD(Lat, Lon, el(prn), az(prn), alpha_n', beta_n', recv_timer.recvSOW_BDS, satpos_n);
