function [recv_channel] = coldBitSync_init(recv_channel, config)
...
switch recv_channel.SYST
    case 'GPS_L1CA'
        ...
        recv_channel.CH_L1CA.bitSync.frange= Gps_Bitsync_config.freqRange;
        recv_channel.CH_L1CA.bitSync.fbin  = Gps_Bitsync_config.freqBin;
    ...
    case 'BDS_B1I'
        ...
        % finer dopplar search
        recv_channel.CH_B1I.bitSync.frange= Bds_Bitsync_config.freqRange;
        recv_channel.CH_B1I.bitSync.fbin  = Bds_Bitsync_config.freqBin;
