function rinexobs_header_dual(pos,recv_time, logName)
%%
%rinex√˚≥∆ ‰»Î
rinex_version=3.02;
file_type='O';
...
obs_type_sys.GPS='G';
obs_type_num.GPS=4;
obs_type_descri.GPS=' C1C L1C S1C D1C';
obs_type_sys.BDS='C';
obs_type_num.BDS=4;
obs_type_descri.BDS=' C1I L1I S1I D1I';
interval=1;
...
fprintf(fid,'%s  %3d%16s                                      SYS / # / OBS TYPES\n',obs_type_sys.GPS,obs_type_num.GPS,obs_type_descri.GPS);
fprintf(fid,'%s  %3d%16s                                      SYS / # / OBS TYPES\n',obs_type_sys.BDS,obs_type_num.BDS,obs_type_descri.BDS);
