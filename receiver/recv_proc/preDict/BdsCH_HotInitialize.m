...
function channel = BdsCH_HotInitialize(channel, Syst, CH_Status, prn, configPage, GSAR_CONSTANTS, predictInfo, device)
...
switch Syst
    case {'BDS_B1I','B1I_L1CA'}
        ...
        channel.CH_B1I.LO2_CarPhs= predictInfo.carriPhase;
        channel.CH_B1I.LO2_IF0   = GSAR_CONSTANTS.STR_RECV.IF_B1I;
        channel.CH_B1I.LO2_fd    = predictInfo.carriDopp;
        channel.CH_B1I.fdPre    = predictInfo.carriDopp;
        channel.CH_B1I.fdIndex    = 0;
        channel.CH_B1I.LO2_framp = 0;
        channel.CH_B1I.codePhaseErr = 0;
        channel.CH_B1I.LO_CodPhs = predictInfo.codePhase;
        channel.CH_B1I.LO_Fcode0 = GSAR_CONSTANTS.STR_B1I.Fcode0;
        channel.CH_B1I.LO_Fcode_fd= predictInfo.codeDopp;
        channel.CH_B1I.Fcode_fdPre = predictInfo.codeDopp;
        channel.CH_B1I.Tcohn_cnt = 0;
        channel.CH_B1I.preUnitNum = 0;
        %Initialize information frame format
        channel.CH_B1I.WN        = predictInfo.WN;
        channel.CH_B1I.SOW       = predictInfo.SOW;
        channel.CH_B1I.Frame_N   = predictInfo.Frame_N;
        channel.CH_B1I.SubFrame_N= predictInfo.SubFrame_N;
        channel.CH_B1I.Word_N    = predictInfo.Word_N;
        channel.CH_B1I.Bit_N     = predictInfo.Bit_N;
        channel.CH_B1I.T1ms_N    = predictInfo.T1ms_N;
        %Initialize the track parameters and registers
        channel.CH_B1I.Trk_Count = 0;
        if prn>5
            channel.CH_B1I.navType = 'B1I_D1';
            channel.CH_B1I.Tcohn_N = 10;
        else
        ...
        channel.CH_B1I.lockDect.sigma_checkT= 1;      
        ...
        channel.CH_B1I.lockDect.WN = predictInfo.WN;
        channel.CH_B1I.lockDect.SOW = predictInfo.SOW;
        channel.CH_B1I.lockDect.Frame_N = predictInfo.Frame_N;
        channel.CH_B1I.lockDect.SubFrame_N = predictInfo.SubFrame_N;
        channel.CH_B1I.lockDect.Word_N = predictInfo.Word_N;
        channel.CH_B1I.lockDect.Bit_N = predictInfo.Bit_N;
        channel.CH_B1I.lockDect.T1ms_N = predictInfo.T1ms_N;
        channel.CH_B1I.lockDect.codePhase = predictInfo.codePhase;
        channel.CH_B1I.lockDect.carriPhase = predictInfo.carriPhase;
        channel.CH_B1I.lockDect.carriDopp = predictInfo.carriDopp;
        channel.CH_B1I.lockDect.codeDopp = predictInfo.codeDopp;
...
%         channel.CH_B1I.CorrM_Bank.corrM_Spacing  = 2;
...
%         channel.CH_B1I.CorrM_Bank.corrM_Loop_I_vt     = zeros(210, 15); %与Loop_I列数一致
...
%         channel.CH_B1I.bitDetect = zeros(3,1); % detect whether nav bit is correct
        ...
        channel.CH_B1I.acq.processing = -1;% -1：初始化，0：经过推算后，1：经过捕获初始化后
        channel.CH_B1I.acq.TimeLen    = 0;
        channel.CH_B1I.acq.hotWaitTime = -9999; % sec
        channel.CH_B1I.acq.hotAcqTime = 0;
        channel.CH_B1I.acq.acq_parameters = CH_Hot_AcqParameters_Init(channel.SYST, ...
        ...
        codePeriod_B1I = GSAR_CONSTANTS.STR_B1I.ChipNum / (GSAR_CONSTANTS.STR_B1I.Fcode0+channel.CH_B1I.LO_Fcode_fd);
        channel.CH_B1I.acq.sampPerTC_s= round(GSAR_CONSTANTS.STR_RECV.fs * codePeriod_B1I);
        ...
        channel.CH_B1I.acq.skipNperCode      =  channel.CH_B1I.acq.sampPerTC_s * ...
            (1 - GSAR_CONSTANTS.STR_B1I.Fcode0/(GSAR_CONSTANTS.STR_B1I.Fcode0+channel.CH_B1I.LO_Fcode_fd));
        ...
        channel.CH_B1I.bitSync.processing = 0;
