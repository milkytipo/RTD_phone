function fadFreq_IGSO(xvector1, yvector1, X1, Y1, ...
    xvector2, yvector2, Y2, ...
    xvector3, yvector3, Y3, ...
    xvector4, yvector4, Y4, ...
    xvector5, yvector5, Y5, ...
    xvector6, yvector6, Y6)
%CREATEFIGURE(XVECTOR1, YVECTOR1, X1, Y1, XVECTOR2, YVECTOR2, Y2, YVECTOR3, Y3, YVECTOR4, Y4, YVECTOR5, Y5, YVECTOR6, Y6)
...
%  由 MATLAB 于 31-Aug-2017 23:29:11 自动生成
...
set(legend1,...
    'Position',[0.221756895285893 0.829395554163579 0.0939611930050802 0.0422623391310886],...
    'FontSize',10);
...
% 创建 plot
plot(X1,Y2,'ZDataSource','','DisplayName','Fitted distribution',...
    'LineWidth',3,...
    'Color',[1 0 0]);
...
% 创建 plot
plot(X1,Y3,'ZDataSource','','DisplayName','Fitted distribution',...
    'LineWidth',3,...
    'Color',[1 0 0]);
...
% 创建 plot
plot(X1,Y4,'ZDataSource','','DisplayName','Fitted distribution',...
    'LineWidth',3,...
    'Color',[1 0 0]);
...
% 创建 plot
plot(X1,Y5,'ZDataSource','','DisplayName','Fitted distribution',...
    'LineWidth',3,...
    'Color',[1 0 0]);
...
% 创建 plot
plot(X1,Y6,'ZDataSource','','DisplayName','Fitted distribution',...
    'LineWidth',3,...
    'Color',[1 0 0]);
